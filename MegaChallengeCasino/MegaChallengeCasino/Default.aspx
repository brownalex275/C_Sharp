...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:Image ID="Image1" runat="server" Height="151px" Width="140px" />
            <asp:Image ID="Image2" runat="server" Height="151px" Width="140px" />
            <asp:Image ID="Image3" runat="server" Height="151px" Width="140px" />
            <br />
            <br />
            Your Bet: <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
            <br />
            <br />
            <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Pull The Lever!" Width="128px" />
            <br />
            <br />
